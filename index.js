...
var chosenMonster = chooseOne(monsters);
var chosenWeapon = chooseOne(weapons);
var chosenAction = chooseOne(actions);
...
function handleClick() {
	...
	document.getElementById("new_adventure").onclick = handleClick;
